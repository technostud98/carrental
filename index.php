      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Hire the best car with the best price</h1>
            <p>We have collection of cars for you to choose. </p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>Love the road. Rent wisely. Fun collection. Small world. Small rates.</p>
    </div>
    <div class="row">
